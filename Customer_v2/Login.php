        ...
        <div class="login-container">
            ...
            <div class="form-box">
                <form action="ac_login.php" method="post">
                    ...
                    <input name="nilaiCaptcha" value=""/>
                    <button class="btn btn-info btn-block login" type="submit" name="but">Login</button>
                </form>
                <p style="font-size: 15px; margin-top: 10px; color: black;">Belum punya akun? <a href="RegisterUser.php" style="text-decoration: none; color: black;">disini!</a></p>
            </div>
        </div>
